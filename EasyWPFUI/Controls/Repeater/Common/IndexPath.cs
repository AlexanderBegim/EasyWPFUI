...
namespace EasyWPFUI.Controls
{
    public class IndexPath
    {
        ...
        public IndexPath(List<int> indices)
        {
            if (indices != null)
            {
                for (var i = 0; i < indices.Count; i++)
        ...
        public static IndexPath CreateFrom(IList<int> indices)
        {
            return new IndexPath(indices);
        }

        public static IndexPath CreateFrom(List<int> indices)
        {
            return new IndexPath(indices);
        }
        ...
        {
            List<int> newPath = new List<int>(m_path);
